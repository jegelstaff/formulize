...
$instSectionData = getData(4, 4, 'instr_assignments_instructor/**/'.$inst.'/**/=][ro_module_year/**/'.$_POST['showYear'].'/**/=][ro_module_course_active/**/1/**/=', 'AND', '', '', '', 'ro_module_course_code');

// also, figure out where they're the coordinator, and show that
$coordData = getData('', 3, 'ro_module_course_coordinator/**/'.$inst.'/**/=][ro_module_year/**/'.$_POST['showYear'].'/**/=', 'AND', '', '', '', 'ro_module_course_code');
$coordCourses = array();
