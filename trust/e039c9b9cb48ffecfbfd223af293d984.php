...
define( 'SDATA_DB_HOST', 'mariadb' );

// Database Username
// Your database user account on the host
define( 'SDATA_DB_USER', 'user' );
...
define( 'SDATA_DB_NAME', 'formulize' );
...
define( 'SDATA_DB_PREFIX', 'i4f0c4086' );
...
define( 'SDATA_DB_SALT', 'gjNtK7jDue6a0kU1iPD9OqwCVaIJ8QZCDFNoxExjQiUs3y9piZiaEff2HAGeTCUDf' );
