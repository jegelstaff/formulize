...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', 'C:/VertrigoServ/www/selenium' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_ROOT_PATH', 'C:/VertrigoServ/www/selenium' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', XOOPS_ROOT_PATH.'/selenium-848d24bb54d726d' );
	define( 'XOOPS_TRUST_PATH', XOOPS_ROOT_PATH.'/selenium-848d24bb54d726d' );

	include_once XOOPS_TRUST_PATH . '/0dd528b71d72ed19bb9dd658ab2dad58.php' ;
