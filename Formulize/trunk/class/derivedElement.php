...
class formulizeDerivedElement extends formulizeformulize {
    ...
    function __construct() {
        $this->name = "Custom Value derived from other elements";
...
class formulizeDerivedElementHandler extends formulizeElementsHandler {
    ...
    function adminPrepare($element) {
        ...
        $numberDecimals = $ele_value[1];
		$numberPrefix = $ele_value[2];
		$decimalSeparator = $ele_value[3];
		$numberSeparator = $ele_value[4];
		
		return array(
			'numberDecimals'=>$numberDecimals, 'numberPrefix'=>$numberPrefix, 
			'decimalSeparator'=>$decimalSeparator, 'numberSeparator'=>$numberSeparator);
    }
