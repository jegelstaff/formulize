...
class formulizeGridElement extends formulizeformulize {
    ...
    function __construct() {
        $this->name = "Custom Table of existing elements";
...
class formulizeGridElementHandler extends formulizeElementsHandler {
    ...
    function adminPrepare($element) {
        ...
        $backgroundShading = $ele_value[3];
		$headingAppearance = $ele_value[5];
		$heading = $ele_value[0];
		
		return array('backgroundShading'=>$backgroundShading, 'headingAppearance'=>$headingAppearance, 'heading'=>$heading);
    }
