...
class formulizeSubformElement extends formulizeformulize {
...
class formulizeSubformElementHandler extends formulizeElementsHandler {
    ...
    function adminPrepare($element) {
        ...
        $blankSpaces = $ele_value[2];
		$includeViewButtons = $ele_value[3];
		return array('blankSpaces'=>$blankSpaces, 'includeViewButtons'=>$includeViewButtons);
    }
