...
class formulizeTextElementHandler extends formulizeElementsHandler {
    ...
    function adminPrepare($element) {
        ...
        $width = $ele_value[0];
		$maxLength = $ele_value[1];
		$defaultValue = $ele_value[3];
		$numberDecimals = $ele_value[5];
		$numberPrefix = $ele_value[6];
		$decimalSeparator = $ele_value[7];
		$numberSeparator = $ele_value[8];
		
		return array(
			'width'=>$width, 'maxLength'=>$maxLength,
			'defaultValue'=>$defaultValue, 'numberDecimals'=>$numberDecimals,
			'numberPrefix'=>$numberPrefix, 'decimalSeparator'=>$decimalSeparator,
