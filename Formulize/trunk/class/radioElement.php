...
class formulizeRadioElement extends formulizeformulize {
...
class formulizeRadioElementHandler extends formulizeElementsHandler {
    ...
    function adminPrepare($element) {
        $options = $element ? $element->getVar('ele_value') : array();
