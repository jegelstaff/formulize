...
define('_MD_AM_ALLOWREG', 'Allow people to create their own accounts?');
define('_MD_AM_ALLOWREGDSC', 'If yes, people can sign up for an account at '.XOOPS_URL.'/signup.php.');
