...
CREATE TABLE `formulize_screen_listofentries` (
  ...
  `editdestination` varchar(10) NOT NULL DEFAULT 'screen',
...
CREATE TABLE `formulize_screen_multipage` (
  ...
  `showpagetitles` tinyint(1) NOT NULL default 0,
  `showpageselector` tinyint(1) NOT NULL default 0,
  `showpageindicator` tinyint(1) NOT NULL default 0,
