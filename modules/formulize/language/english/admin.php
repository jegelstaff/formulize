...
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_EXPLAIN","For each entry in this form, should a user account be created so that the person can login to Formulize?");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_GROUPS","This form represents groups");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_GROUPS_EXPLAIN","For each entry in this form, should a group be created in Formulize?");
