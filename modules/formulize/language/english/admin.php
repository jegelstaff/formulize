...
define("_AM_FORM_SCREEN_ENTRIES_DISPLAY","Data to be displayed");
...
define("_AM_FORMULIZE_SCREEN_LOE_DEFAULTVIEW", "What scope or published view should be used as the default?");
...
define("_AM_FORMULIZE_SCREEN_LOE_DESC_DEFAULTVIEW", "If you are customizing the list template, the default scope/view will still be used to control which entries are initially included in the list.");
