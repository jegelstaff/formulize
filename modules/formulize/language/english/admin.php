...
define("_AM_SETTINGS_FORM_TYPE_GROUPS_SETTINGS","Group Settings");
...
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_DEFAULT_GROUPS_CONDITIONS_SHOW","show conditions");
...
define("_AM_SETTINGS_FORM_GROUP_CATEGORIES_NOTE","Example: if this form tracks projects, you could create categories like \"Managers\" and \"Staff\", in addition to the basic \"All Users\" category. Then, if there's an entry in this form called \"Annual Budget\", you would be able to organize users into groups for each category. ie: <ul style='margin-top: 1em;'><li style='list-style: disc; padding: 0;'>Annual Budget - All Users</li><li style='list-style: disc; padding: 0;'>Annual Budget - Managers</li><li style='list-style: disc; padding: 0;'>Annual Budget - Staff</li></ul>");
