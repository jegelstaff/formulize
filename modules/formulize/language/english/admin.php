...
define("_AM_MAP_ELEMENTS_LEGEND","Map Elements");
define("_AM_MAP_LAT_ELEMENT_LABEL","Latitude Element");
define("_AM_MAP_LAT_ELEMENT_DESC","The form element whose value contains the latitude coordinate for each entry.");
define("_AM_MAP_LNG_ELEMENT_LABEL","Longitude Element");
define("_AM_MAP_LNG_ELEMENT_DESC","The form element whose value contains the longitude coordinate for each entry.");
define("_AM_MAP_LABEL_ELEMENT_LABEL","Label Element");
define("_AM_MAP_LABEL_ELEMENT_DESC","The form element whose value is used as the heading in the map popup for each entry.");
define("_AM_MAP_DESC_ELEMENT_LABEL","Description Element (optional)");
define("_AM_MAP_DESC_ELEMENT_DESC","An optional element whose value appears as a paragraph below the label in the popup.");
define("_AM_MAP_SELECT_DEFAULT","-- select --");
define("_AM_MAP_NONE_DEFAULT","-- none --");
define("_AM_MAP_FILTERS_LEGEND","Filters");
define("_AM_MAP_FILTERS_INTRO","Specify which elements users can filter by above the map. The search term column pre-fills the filter with a default value.");
define("_AM_MAP_ADD_FILTER_COLUMN","Add Filter Column");
define("_AM_MAP_COLUMN_HEADING","Column");
define("_AM_MAP_DEFAULT_SEARCH_TERM_HEADING","Default Search Term");
define("_AM_MAP_FILTER_TYPE_HEADING","Filter Type");
define("_AM_MAP_SEARCH_TYPE_BOX","Search Box");
define("_AM_MAP_SEARCH_TYPE_FILTER","Dropdown List - select value");
define("_AM_MAP_SEARCH_TYPE_NEG_FILTER","Dropdown List - exclude value");
define("_AM_MAP_SEARCH_TYPE_MULTI","Checkboxes");
define("_AM_MAP_SEARCH_TYPE_DATE","Date Range");
define("_AM_MAP_FUNDAMENTAL_FILTERS_HEADING","Fundamental Filters");
define("_AM_MAP_FUNDAMENTAL_FILTERS_DESC","These filters are always applied and are never shown to end users. New entries created through this screen will have values set based on any 'Match all' filters using the equals operator.");
...
define("_AM_MAP_FILTER_BUTTON_DEFAULT","Filter");
define("_AM_MAP_TILES_LEGEND","Map Tiles");
define("_AM_MAP_TILESET_LABEL","Tile Layer");
define("_AM_MAP_TILESET_OSM","OpenStreetMap (roads)");
define("_AM_MAP_TILESET_TOPO","OpenTopoMap (terrain)");
define("_AM_MAP_TILESET_ESRI","Esri World Imagery (satellite)");
define("_AM_MAP_TILESET_CUSTOM","Custom...");
define("_AM_MAP_TILESET_URL_LABEL","Tile URL template");
define("_AM_MAP_TILESET_URL_DESC","Leaflet URL template, e.g. https://tiles.example.com/{z}/{x}/{y}.png?key={key}. Use {key} where your API key should appear.");
define("_AM_MAP_TILESET_KEY_LABEL","API key / access token");
define("_AM_MAP_TILESET_KEY_DESC","Leave blank if no key is required. Will be substituted for {key} in the URL above.");
define("_AM_MAP_TILESET_ATTRIBUTION_LABEL","Attribution");
define("_AM_MAP_TILESET_ATTRIBUTION_DESC","Attribution HTML shown on the map (required by most providers).");
define("_AM_MAP_TEMPLATES_THEME_LABEL","Showing templates for use with this theme:");
define("_AM_MAP_TEMPLATES_TOP_LEGEND","Top Template");
define("_AM_MAP_TEMPLATES_MAP_LEGEND","Map Template");
define("_AM_MAP_TEMPLATES_BOTTOM_LEGEND","Bottom Template");
...
define("_AM_SETTINGS_FORM_TYPE","What does each entry in this form represent?");
define("_AM_SETTINGS_FORM_TYPE_DATA","Data records");
define("_AM_SETTINGS_FORM_TYPE_DATA_DESC","entries are people, places, things, events, or any other kind of information your organization tracks");
define("_AM_SETTINGS_FORM_TYPE_USERS","People with accounts");
define("_AM_SETTINGS_FORM_TYPE_USERS_DESC","each entry corresponds to a person who can log in to the system; saving an entry creates or updates their account, password, and profile");
define("_AM_SETTINGS_FORM_TYPE_GROUPS","Groups of people");
define("_AM_SETTINGS_FORM_TYPE_GROUPS_DESC","each entry defines a group, such as a team or department, whose members share the same level of access to forms and data");
define("_AM_SETTINGS_FORM_TYPE_USERS_SETTINGS","User Account Settings");
define("_AM_SETTINGS_FORM_TYPE_GROUPS_SETTINGS","User Categories for each entry in this form");
...
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_EXPLAIN","For each entry in this form, a user account will be created in Formulize.");
	...
	define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_USER_IS_OWNER_EXPLAIN","For example, if you have a Referral form that contains names, email addresses, phone numbers, etc, you might want the users arising from each entry to be the owners of their data, so they can edit it, etc.");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_CONDITIONS_TITLE","Conditions for Creating User Accounts (optional)");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_CREATION_SCOPE","Create a user account for:");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_CREATION_ALL","All entries");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_CREATION_CONDITIONAL","Only entries matching conditions...");
...
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_DEFAULT_GROUPS_TEMPLATE_FORM_LABEL","The %s form");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_DEFAULT_GROUPS_TEMPLATE_VALIDATION","Each template group must have at least one element selected.");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_DEFAULT_GROUPS_REMOVE","remove group");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_DEFAULT_GROUPS_CONDITIONS_SHOW","show");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_DEFAULT_GROUPS_CONDITIONS_CONDITIONS","conditions");
...
define("_AM_SETTINGS_FORM_GROUP_CATEGORIES_ALL_USERS","All Users");
define("_AM_SETTINGS_FORM_GROUP_CATEGORIES_ADD","Add Category");
define("_AM_SETTINGS_FORM_GROUP_CATEGORIES_PLACEHOLDER","Category name");
define("_AM_SETTINGS_FORM_GROUP_CATEGORIES_REMOVE","Remove this category");
define("_AM_SETTINGS_FORM_GROUP_CATEGORIES_NOTE","Example: you could create categories like \"Managers\" and \"Staff,\" in addition to the basic \"All Users\" category. If the form is for projects, and you create an entry called \"Annual Budget,\" you would automatically have groups for each category. ie: <ul style='margin-top: 1em;'><li style='list-style: disc; padding: 0;'>Annual Budget - All Users</li><li style='list-style: disc; padding: 0;'>Annual Budget - Managers</li><li style='list-style: disc; padding: 0;'>Annual Budget - Staff</li></ul>");
define("_AM_SETTINGS_FORM_USER_MAPPING_TITLE","Associate Existing Entries with Existing Users");
define("_AM_SETTINGS_FORM_USER_MAPPING_EXPLAIN","To associate existing entries with existing users, one of the elements in this form needs to contain the usernames, email addresses, or user ID numbers of existing users.");
define("_AM_SETTINGS_FORM_USER_MAPPING_ELEMENT_LABEL","This element:");
define("_AM_SETTINGS_FORM_USER_MAPPING_ELEMENT_SELECT","-- Select an element --");
define("_AM_SETTINGS_FORM_USER_MAPPING_CONTAINS_LABEL","Contains:");
define("_AM_SETTINGS_FORM_USER_MAPPING_TYPE_USERNAME","Usernames");
define("_AM_SETTINGS_FORM_USER_MAPPING_TYPE_EMAIL","Email addresses");
define("_AM_SETTINGS_FORM_USER_MAPPING_TYPE_UID","User IDs");
define("_AM_SETTINGS_FORM_CREATE_ENTRIES_TITLE","Create New Entries for Existing Users");
define("_AM_SETTINGS_FORM_CREATE_ENTRIES_INCLUDE_GROUPS","Create entries for users who are members of all of these groups:");
define("_AM_SETTINGS_FORM_CREATE_ENTRIES_EXCLUDE_GROUPS","Exclude users who are members of any of these groups (optional):");
define("_AM_SETTINGS_FORM_CREATE_ENTRIES_PROXY_LABEL","Record new entries as created by:");
...
define("_AM_ELE_TEXTAREA_LIMIT_QUESTION","Show a word or character counter below this box?");
define("_AM_ELE_TEXTAREA_LIMIT_NONE","No");
define("_AM_ELE_TEXTAREA_LIMIT_CHARS","Character counter");
define("_AM_ELE_TEXTAREA_LIMIT_WORDS","Word counter");
define("_AM_ELE_TEXTAREA_LIMIT_NUMBER","Is there a limit on how many the user can type? (0 for no limit)");
...
define("_AM_FORMULIZE_SCREEN_LOE_USEVIEWENTRYLINKS_PEN", "Yes - use the pen icon");
define("_AM_FORMULIZE_SCREEN_LOE_USEVIEWENTRYLINKS_MAGNIFIER", "Yes - use the magnifying glass icon");
define("_AM_FORMULIZE_SCREEN_LOE_DEDISPLAY_PEN", "Display them when the user clicks a pen icon to activate them");
define("_AM_FORMULIZE_SCREEN_LOE_DEDISPLAY_MAGNIFIER", "Display them when the user clicks a magnifying glass icon to activate them");
...
define("_AM_SCREEN_SETTINGS_EMBED_ORIGINS_DESC", "One website per line. Write each as a domain, for example <em>www.example.com</em>, or with a scheme, <em>https://www.example.com</em>. A pasted page address works too, and <em>*.example.com</em> covers every subdomain. Those websites will be allowed to show this screen inside an iframe. Write the website whose page shows the screen, not an embedding address you have set up for it: for a page on <em>www.example.com</em> embedding the screen through <em>forms.example.com</em>, write <em>www.example.com</em>. Until you list one, no other website can embed this screen at all: browsers refuse to display it anywhere but this site.<br><br>Leaving out the scheme does not mean either one is allowed: the browser only matches it against this site's own scheme, https on almost every site. A website using plain http instead, such as a local development site, needs to be written as <em>http://www.example.com</em>, or the browser will refuse to display this screen there.");
define("_AM_SCREEN_SETTINGS_EMBED_CODE", "Code for the other website's page");
define("_AM_SCREEN_SETTINGS_EMBED_CODE_DESC", "Paste one of these into the page that is to display the screen. Include the script once per page, however many screens that page shows. Each screen stays as tall as its content, so there is no height to guess at, and as wide as the page gives it, but never narrower than 400 pixels, so it cannot end up too narrow to use.<br><br>How embedding works, start to finish: <a href='https://formulize.org/developers/embedding_screens/' target='_blank'>formulize.org/developers/embedding_screens</a>");
define("_AM_SCREEN_SETTINGS_EMBED_CODE_ANON", "For anonymous visitors, using this site's address (%s)");
define("_AM_SCREEN_SETTINGS_EMBED_CODE_ANON_DESC", "Works as it is. Visitors are anonymous inside the frame, even if they are signed in to this site.");
define("_AM_SCREEN_SETTINGS_EMBED_CODE_ALIAS", "For signed-in visitors, and for submitting in every browser, using an embedding address");
define("_AM_SCREEN_SETTINGS_EMBED_CODE_ALIAS_DESC", "Replace <code>%1\$s</code> in both places with the embedding address you have set up, eg. <em>forms.example.com</em>. Formulize can't know what that address is. Setting up an embedding address: <a href='https://formulize.org/developers/embedding_screens_setup/' target='_blank'>formulize.org/developers/embedding_screens_setup</a>");
...
define("_AM_EMBED_SESSION_DEPENDS_BODY", "The session cookie for this site is set to <code>SameSite=%s</code>, under Sessions &amp; cookies. Browsers send it into a frame only when the page doing the framing is on the same domain as the address in the iframe, and uses the same https or http. That address does not have to be the one you use to reach this site: an address set up on the other website's own domain, pointing at this server, counts as that domain. Embedded on the same domain, a screen shows the visitor their own data and saves normally, exactly as it would here. Embedded on any other domain, the session does not reach it: the screen is anonymous however the visitor is signed in, it can only show what the Anonymous group is allowed to see, and a passcode screen asks for the passcode again on the next page. <b>Anonymous visitors can still submit it</b>, as long as this site is https and their browser keeps a cookie for the embedded page - Safari does not, by default, and offers them a link to open the screen in its own window instead. Setting up an address on the same domain: <a href='https://formulize.org/developers/embedding_screens_setup/' target='_blank'>formulize.org/developers/embedding_screens_setup</a>");
define("_AM_EMBED_SESSION_LIST_SAME", "<b>These are on the same domain as %s</b>, the address you are viewing this page from, so screens embedded there using that address are signed in and can be submitted:");
define("_AM_EMBED_SESSION_LIST_CROSS", "<b>These are on a different domain from %s</b>, the address you are viewing this page from. A screen embedded there using that address is anonymous, whoever is looking at it, though anonymous visitors can still submit. If you have set up an address on that website's own domain and put it in the iframe, the screen is signed in there instead:");
