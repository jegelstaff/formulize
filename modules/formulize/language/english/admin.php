...
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_DEFAULT_GROUPS_TEMPLATE_DESC","Assign to the %s group(s) based on the %s selected in:");
...
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_DEFAULT_GROUPS_CONDITIONS_HIDE","hide");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_DEFAULT_GROUPS_CONDITIONS_DESC","Optionally, set conditions to control when a user is added to this group. If no conditions are set, users are always added to this group.");
...
define("_AM_SETTINGS_FORM_USER_MAPPING_QUESTION","You have existing entries in this form. Do you wish to associate those entries with existing user accounts?");
...
define("_AM_SETTINGS_FORM_USER_MAPPING_SYNC_NOTE","A one-time synchronization of users and entries in this form will be performed when you save your changes.");
