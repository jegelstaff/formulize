...
// --- The site-wide AI API key field (formulizeAIApiKey) ---
...
// --- The AI model picker (formulizeAIModel, rendered by name rather than formtype) ---
define('_AM_CFG_AIMODEL_LOADING', 'Loading models...');
define('_AM_CFG_AIMODEL_NONE_FOUND', 'No models were returned for this key.');
define('_AM_CFG_AIMODEL_FAILED', 'Could not load the list of models:');
