...
define("_AM_CONFIRM_DEL_FF_FORM", "You are about to remove this set of forms from the Relationship!  Please confirm.");
...
define("_AM_FRAME_ADDFORM", "Add a pair of forms to this Relationship");
define("_AM_FRAME_FORMSIN", "Forms in this Relationship");
define("_AM_FRAME_DELFORM", "Remove");
define("_AM_FRAME_EDITFORM", "Details for:");
define("_AM_FRAME_DONEBUTTON", "Done");
define("_AM_FRAME_NOFORMS", "There are no forms in this Relationship");
...
define("_AM_FRAME_EACH", "each");
define("_AM_FRAME_ONE", "one");
define("_AM_FRAME_HAS", "has");
define("_AM_FRAME_MANY", "many");
...
define("_formulize_MANAGE_VIEWS_TITLE", "Views:");
define("_formulize_MANAGE_SELECTION_TITLE", "Select entries:");
...
define("_formulize_DE_ADDSINGULAR", "Add %s");
define("_formulize_DE_UPDATESINGULAR", "Update my %s");
define("_formulize_DE_ADD_MULTIPLE_ENTRY", "Add multiple entries");
define("_formulize_DE_ADD_PLURAL_ENTRY", "Add %s");
define("_formulize_DE_PROXYENTRY", "Make a proxy entry");
define("_formulize_DE_UPDATEENTRY", "Update my entry");
define("_formulize_DE_DELETESEL", "Delete selected");
define("_formulize_DE_CLONESEL", "Clone selected");
define("_formulize_DE_CHANGEOWNER", "Change owner");
define("_formulize_DE_CLONE_PROMPT", "How many copies of the selected entries do you want to make? (use numbers, not words)");
define("_formulize_DE_CLONE_SELECT_FORMS", "Select which forms to include when cloning:");
define("_formulize_DE_CLONE_NUM_COPIES", "Number of copies:");
define("_formulize_DE_CLONE_CONFIRM_BUTTON", "Clone");
define("_formulize_DE_CLONE_CANCEL_BUTTON", "Cancel");
...
define("_formulize_DE_DELETE_USER_BUTTON", "Delete user");
define("_formulize_DE_DELETE_USER_CONFIRM", "Do you really want to delete %s?\n\nAny data they have entered will still be associated with their groups, but we will no longer have a name on file for who created the data. Consider disabling their account instead.\n\nClick OK to delete. Click Cancel to keep their account.");
define("_formulize_DE_DELETE_GROUP_BUTTON", "Delete group");
define("_formulize_DE_DELETE_GROUP_CONFIRM", "Do you really want to delete the group \"%s\"?\n\nThis cannot be undone.\n\nClick OK to delete. Click Cancel to keep the group.");
define("_formulize_UA_STATUS_ACTIVE", "Active");
define("_formulize_UA_STATUS_DISABLED", "Disabled");
define("_formulize_UA_STATUS_PENDING", "Pending confirmation");
...
define("_formulize_DE_FREEZECOLUMN", "Click to freeze this column so it's visible when you scroll right");
...
define("_formulize_DE_GROUPBYOWNERGROUPS", "Group by: Creator's groups");
...
define("_formulize_DE_CALC_OWNERGROUPS", "Creator's groups");
...
define("_formulize_USERACCOUNTFULLNAME", "Full Name");
...
define("_formulize_USERACCOUNTSTATUS", "Account Status");
define("_formulize_USERACCOUNTREGISTRATIONDATE", "Registration Date");
define("_formulize_USERACCOUNTLASTLOGIN", "Last Login");
define("_formulize_USERACCOUNTMASQUERADE", "Masquerade");

// Self-service signup (signup.php)
define("_formulize_SIGNUP_TITLE", "Create an Account");
define("_formulize_SIGNUP_ACCOUNT_DETAILS", "Your account details");
define("_formulize_SIGNUP_CREATE_BUTTON", "Create Account");
define("_formulize_SIGNUP_SENDING", "Creating your account…");
define("_formulize_SIGNUP_NO_CONTACT", "We could not find a way to send you a confirmation code. Please contact the site administrator for help activating your account.");
define("_formulize_SIGNUP_TOKEN_PROMPT", "Have an invitation code? Enter it here:");
define("_formulize_SIGNUP_TOKEN_PROMPT_REQUIRED", "An invitation code is required to sign up. Enter it here:");
define("_formulize_SIGNUP_TOKEN_REQUIRED", "You need a valid invitation code to create an account. Enter your code above to continue.");
define("_formulize_SIGNUP_TOKEN_APPLY", "Apply");
define("_formulize_SIGNUP_TOKEN_ACCEPTED", "Invitation code accepted.");
define("_formulize_SIGNUP_TOKEN_GRANTS", "You will be added to: %s.");
define("_formulize_SIGNUP_TOKEN_REMOVE", "Remove");
define("_formulize_SIGNUP_TOKEN_EMPTY", "Please enter an invitation code, or leave it blank to continue without one.");
define("_formulize_SIGNUP_TOKEN_INVALID", "That invitation code is not valid or has expired. You can still create an account without a code.");
define("_formulize_SIGNUP_CONFIRM_TITLE", "Confirm Your Account");
define("_formulize_SIGNUP_CONFIRM_INSTRUCTIONS", "We sent a confirmation code to %s. Enter it below to activate your account.");
define("_formulize_SIGNUP_CONFIRM_BUTTON", "Confirm");
define("_formulize_SIGNUP_BAD_CODE", "That code was not correct. Please try again.");
define("_formulize_SIGNUP_RESEND", "send a new code");
define("_formulize_SIGNUP_RESEND_PROMPT", "Didn't get it? You can %s.");
...
define("_formulize_GMM_MEMBER", "member");
...
define("_formulize_GMM_SEARCH_BUTTON", "Search");
define("_formulize_GMM_REMOVE_BUTTON", "Remove");
define("_formulize_GMM_CANCEL_BUTTON", "Cancel");
define("_formulize_GMM_ADD_BUTTON", "Add");
define("_formulize_GMM_SEARCHING", "Searching…");
define("_formulize_GMM_NO_MEMBERS_FOUND", "No members found.");
define("_formulize_GMM_ERROR_LOADING", "Error loading members.");
define("_formulize_GMM_PENDING_REMOVALS", "Pending removals (saved with form):");
define("_formulize_GMM_MIN_CHARS", "Enter at least 2 characters to search.");
define("_formulize_GMM_NO_USERS_FOUND", "No users found.");
define("_formulize_GMM_NO_NEW_USERS", "No new users found (all may already be pending).");
define("_formulize_GMM_ERROR_SEARCHING", "Error searching.");
define("_formulize_GMM_PENDING_ADDITIONS", "Pending additions (saved with form):");
define("_formulize_UA_MASQUERADE_BUTTON", "Masquerade");
define("_formulize_UA_MASQUERADE_HELP", "View the site as this user");
