...
define("_formulize_MSG_SENT", "Il tuo messaggio � stato inviato con successo!");
...
define("_formulize_MSG_BIG","Il file da allegare � troppo grande.");
...
define("_MD_ERRORMAIL","ERRORE: Non hai specificato la destinazione del form!");

define("_FORM_ACT","Azione");
define("_FORM_CREAT","Crea un nuovo form");
define("_FORM_RENOM","Rinomina un form");
define("_FORM_RENOM_IMG","<img src='../images/attach.png'>");
define("_FORM_SUP","Cancella un form");
define("_FORM_ADD","Invia parametri");
define("_FORM_SHOW","Esamina i risultati");
define("_FORM_TITLE","Titolo del form :");
define("_FORM_EMAIL","Indirizzo email : ");
define("_FORM_ADMIN","Invia solo all'amministratore :");
define("_FORM_EXPE","Ricevi il form compilato :");
define("_FORM_GROUP","Invia ad un gruppo :");
define("_FORM_DELTITLE","Form da cancellare :");
define("_FORM_MODIF","Modifica un form");
define("_FORM_NEW","Nuovo Form");
define("_FORM_NOM","Inserisci un nuovo nome file");
define("_FORM_OPT","Opzioni");
