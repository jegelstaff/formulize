...
define("_AM_EMBED_SESSION_DEPENDS_BODY", "Le cookie de session de ce site est défini sur <code>SameSite=%s</code>, dans Sessions et cookies. Les navigateurs ne l'envoient dans un cadre que si la page qui affiche ce cadre se trouve sur le même domaine que ce site (%s) et utilise le même https ou http. Intégré là, un écran montre au visiteur ses propres données, exactement comme il le ferait ici. Intégré sur tout autre domaine, aucune session ne lui parvient : l'écran est anonyme quelle que soit la connexion du visiteur, il ne peut montrer que ce que le groupe Anonyme est autorisé à voir, et un écran que les visiteurs anonymes ne peuvent pas utiliser apparaîtra vide.");
define("_AM_EMBED_SESSION_LIST_SAME", "<b>Ces sites partagent la session de ce site</b> : les écrans qui y sont intégrés sont connectés :");
define("_AM_EMBED_SESSION_LIST_CROSS", "<b>Pour le navigateur, ces sites sont un site différent</b> : les écrans qui y sont intégrés sont anonymes :");
define("_AM_EMBED_SESSION_DEPENDS_LMS", "Si vous faites l'intégration dans un système situé sur un autre domaine et que vos utilisateurs doivent y voir leurs propres données, comme une plateforme d'apprentissage, changez le réglage SameSite pour <i>None</i>. Lisez la note qui apparaîtra ici à ce moment-là avant de décider.");
