...
define("_AM_SCREEN_SETTINGS_EMBED_CODE_DESC", "Collez ceci dans la page qui doit afficher l'écran. Incluez le script une seule fois par page, quel que soit le nombre d'écrans qu'elle affiche. Il ajuste la hauteur de chaque écran à son contenu, il n'y a donc aucune hauteur à deviner.<br><br>Remplacez l'adresse dans le code par une adresse sur le même domaine que la page où vous le collez, et mettez cette adresse en place sur ce serveur, sinon les visiteurs ne seront pas connectés et ne pourront pas enregistrer l'écran : <a href='https://formulize.org/developers/embedding_screens_setup/' target='_blank'>formulize.org/developers/embedding_screens_setup</a>");
