...
define("_AM_SCREEN_SETTINGS_EMBED_CODE_DESC", "Collez ce code dans la page qui doit afficher l'écran. Incluez le script une seule fois par page, quel que soit le nombre d'écrans qu'elle affiche. Chaque écran conserve la hauteur de son contenu, il n'y a donc aucune hauteur à deviner, et prend la largeur que la page lui accorde, sans jamais descendre sous 400 pixels, pour ne pas devenir trop étroit pour être utilisable.");
define("_AM_SCREEN_SETTINGS_EMBED_CODE_ADDRESS_DESC", "Remplacez <code>%1\$s</code> aux deux endroits. Ce peut être l'URL de ce site, <code>%2\$s</code>, si seuls des utilisateurs anonymes doivent accéder à l'écran. Pour les utilisateurs connectés, consultez la <a href='https://formulize.org/documentation/embedding_screens/' target='_blank'>documentation sur l'intégration des écrans sur formulize.org</a>.");
define("_AM_SCREEN_SETTINGS_CODE_COPY", "Copier");
define("_AM_SCREEN_SETTINGS_CODE_COPIED", "Copié");
