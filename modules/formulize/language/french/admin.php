...
define("_AM_SETTINGS_FORM_ENTRIES_ARE_USERS_EXPLAIN","Pour chaque entrée de ce formulaire, faut-il créer un compte utilisateur pour que la personne puisse se connecter à Formulize?");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_GROUPS","Ce formulaire représente des groupes");
define("_AM_SETTINGS_FORM_ENTRIES_ARE_GROUPS_EXPLAIN","Pour chaque entrée de ce formulaire, faut-il créer un groupe dans Formulize?");
