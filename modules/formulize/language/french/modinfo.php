...
define("_MI_formulize_TFA_REMEMBER_DEVICE_DAYS", "Pendant combien de jours un appareil doit-il rester mémorisé pour l'authentification à deux facteurs?");
define("_MI_formulize_TFA_REMEMBER_DEVICE_DAYS_DESC", "Lorsqu'un utilisateur réussit une vérification d'authentification à deux facteurs, il peut choisir de mémoriser l'appareil qu'il utilise, afin qu'un code ne lui soit pas redemandé sur cet appareil pendant un certain temps. Ce paramètre contrôle la durée de cette mémorisation, en jours. Entrez un nombre entre 1 et 365 (les valeurs hors de cette plage sont automatiquement ramenées à la limite la plus proche). La valeur par défaut est de 30 jours. Une durée plus courte est plus sécurisée; une durée plus longue est plus pratique.");
