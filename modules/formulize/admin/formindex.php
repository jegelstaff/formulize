    ...
    INDEX i_external_id_string (external_id_string(10))
        ...
        foreach($sql as $key=>$thissql) {
            if (!$result = $xoopsDB->queryF($thissql)) {
                ...
                } elseif($key === "add_entries_are_users" OR $key === "add_entries_are_users_conditions" OR $key === "add_entries_are_users_default_groups" OR $key === "add_entries_are_users_default_groups_element_links" OR $key === "add_entries_are_groups") {
