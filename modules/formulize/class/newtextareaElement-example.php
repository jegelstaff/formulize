...
class formulizeNewTextareaElement extends formulizeformulize {
    
    function __construct() {
        $this->name = "Custom Multi-line text box";
...
class formulizeNewTextareaElementHandler extends formulizeElementsHandler {
    ...
    function create() {
        return new formulizeNewTextareaElement();
    }
