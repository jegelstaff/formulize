...
class formulizeNewDerivedElement extends formulizeformulize {
...
class formulizeNewDerivedElementHandler extends formulizeElementsHandler {
    ...
    function create() {
        return new formulizeNewDerivedElement();
    }
