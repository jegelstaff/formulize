...
class formulizeUserAccountRegistrationDateElementHandler extends formulizeUserAccountElementHandler {
	...
	/**
	 * Render the registration date as a read-only label (system-managed value).
	 *
	 * @param mixed  $ele_value  Unix timestamp of the registration date
	...
	/**
	 * Build a WHERE clause fragment searching by registration date.
	 *
