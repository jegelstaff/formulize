...
class formulizeNewTextElement extends formulizeformulize {
...
class formulizeNewTextElementHandler extends formulizeElementsHandler {
    ...
    function create() {
        return new formulizeNewTextElement();
    }
