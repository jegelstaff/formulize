...
class formulizeNewIbElementHandler extends formulizeElementsHandler {
    ...
    function create() {
        return new formulizeNewIbElement();
    }
    ...
    function adminPrepare($element) {
        $ib_style_options = array('head'=>"head", 'form-heading'=>"form-heading");
		return array('ib_style_options'=>$ib_style_options);
    }
