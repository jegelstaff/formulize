...
class formulizeListOfEntriesScreen extends formulizeScreen {
	...
	function formulizeListOfEntriesScreen() {
		$this->formulizeScreen();
                ...
                $this->initVar("defaultview", XOBJ_DTYPE_TXTBOX);
