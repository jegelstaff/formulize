...
$modversion['help'] = "docs/pageworks_admin.html";
$modversion['license'] = "GPL";
$modversion['official'] = 0;
$modversion['image'] = "images/pageworks.gif";
$modversion['dirname'] = "pageworks";
...
$modversion['tables'][] = "pageworks_pages";
$modversion['tables'][] = "pageworks_frameworks";
$modversion['tables'][] = "pageworks_log";
...
$modversion['search']['func'] = "pageworks_search";

// Templates
$modversion['templates'][0]['file'] = 'pageworks_index.html';
$modversion['templates'][0]['description'] = 'pageworks Template Page';
