...
define("_AM_ELE_TEXT_DESC","{UNAME} stamperà il nome utente;<br />{EMAIL} stamperà l'indirizzo di posta dell'utente");
...
define("_AM_ELE_YN","Pulsanti semplici di scelta sì/no ");
define("_AM_ELE_DATE","Data");
define("_AM_ELE_REQ_USELESS","Non usabile per caselle di scelta, caselle di controllo nè pulsanti di scelta");
...
define("_AM_ELE_OPT_DESC1","<br />Se la scelta multipla non è permessa solo il primo campo spuntato è utilizzato");
...
define("_AM_ELE_MULTIPLE","Permesse più scelte");
