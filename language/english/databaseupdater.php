...
define("_DATABASEUPDATER_MSG_TOKENS_NOT_WRITABLE", "<p><strong>CRITICAL ERROR:</strong> The <strong>%s</strong> folder does not exist or is not writable.</p><p>This folder is critical for the site to function properly. Please ensure the folder exists and has write permissions (chmod 777 or similar), then try the update again.</p>");
