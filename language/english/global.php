...
define("_US_TO_TURN_OFF","To turn off Two-Factor Authentication, please enter the code sent to %s.");
define("_US_TO_TURN_OFF_APP","To turn off Two-Factor Authentication, please enter the code from your authenticator app.");
define("_US_TURN_ON_PHONE","To turn on Two-Factor Authentication, please enter the code we texted to %s.");
define("_US_TURN_ON_EMAIL","To turn on Two-Factor Authentication, please enter the code we emailed to %s.");
...
define("_US_FORGET_DEVICES_BUTTON", "Forget Remembered Devices");
define("_US_FORGET_DEVICES_DONE", "Your remembered devices have been cleared");
...
define("_US_TO_CONFIRM_CHANGE_APP","To confirm this change, please enter the code from your authenticator app.");
define("_US_2FA_NOW_ENTER_CODE","Now, enter the code we sent to %s.");
...
define("_US_LOSTPASS_ENTER_CODE", "Enter your verification code:");
