...
if (defined('XOOPS_ROOT_PATH') AND file_exists(XOOPS_ROOT_PATH . '/modules/formulize/language/french/formulize_dateformats.php')) {
	include XOOPS_ROOT_PATH . '/modules/formulize/language/french/formulize_dateformats.php';
}
if (!defined("_DATESTRING")) define("_DATESTRING","G:i, j F Y");
...
if (!defined("_SHORTDATESTRING")) define("_SHORTDATESTRING","Y-m-d");
if (!defined("_SHORTTIMESTRING")) define("_SHORTTIMESTRING","G:i");
/*
...
define("_US_TO_TURN_OFF","Pour désactiver l'authentification à deux facteurs, veuillez entrer le code envoyé à %s.");
define("_US_TO_TURN_OFF_APP","Pour désactiver l'authentification à deux facteurs, veuillez entrer le code de votre application d'authentification.");
define("_US_TURN_ON_PHONE","Pour activer l'authentification à deux facteurs, veuillez entrer le code que nous avons envoyé par SMS au %s.");
define("_US_TURN_ON_EMAIL","Pour activer l'authentification à deux facteurs, veuillez entrer le code que nous avons envoyé à %s.");
...
define("_US_FORGET_DEVICES_BUTTON", "Réinitialiser vos appareils mémorisés");
...
define("_US_TO_CONFIRM_CHANGE_APP","Pour confirmer ce changement, veuillez entrer le code de votre application d'authentification.");
define("_US_2FA_NOW_ENTER_CODE","Maintenant, entrez le code que nous avons envoyé à %s.");
