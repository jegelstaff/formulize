<?php
// $Id: edituser.php,v 1.26 2005/06/26 15:38:21 mithyt2 Exp $
//  ------------------------------------------------------------------------ //
...
// *********************************
// MODIFIED BY FREEFORM SOLUTIONS -- JANUARY 3 2006
// *********************************

/* save user operation no longer applicable
...
if ($op == 'editprofile') {
	...
	// figure out which profile form entry belongs to the current user
	// Profile form MUST be a one-entry-per-user form!!
...
/* form is replaced with displayform call to Formulize
