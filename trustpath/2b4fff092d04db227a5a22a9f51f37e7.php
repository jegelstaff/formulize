...
define( 'SDATA_DB_HOST', 'SDATA_DB_HOST' );

// Database Username
// Your database user account on the host
define( 'SDATA_DB_USER', 'SDATA_DB_USER' );

// Database Password
// Password for your database user account
define( 'SDATA_DB_PASS', 'SDATA_DB_PASS' );

// Database Name
// The name of database on the host. The installer will attempt to create the database if not exist
define( 'SDATA_DB_NAME', 'SDATA_DB_NAME' );
...
define( 'SDATA_DB_PREFIX', 'SDATA_DB_PREFIX' );
...
define( 'SDATA_DB_SALT', 'SDATA_DB_SALT' );
?>