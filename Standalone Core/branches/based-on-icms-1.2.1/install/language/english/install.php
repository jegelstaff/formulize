...
define( "INTRODUCTION_TITLE", "Welcome to the Formulize installation assistant"); // "Welcome to the ImpressCMS installation assistant" );		// L0 // altered by freeform solutions for the formulize 4 installer
...
define( "XOOPS_URL_HELP", "Main URL that will be used to access your Formulize installation" ); // L58 // altered by freeform solutions for the formulize 4 installer
...
define( "READY_CREATE_TABLES", "No Formulize/ImpressCMS tables were detected.<br />The installer is now ready to create the Formulize/ImpressCMS system tables.<br />Press <em>next</em> to proceed." ); // altered by freeform solutions for the formulize 4 installer
define( "XOOPS_TABLES_FOUND", "The Formulize/ImpressCMS system tables already exists in your database.<br />Press <em>next</em> to go to the next step." ); // L131 // altered by freeform solutions for the formulize 4 installer
...
define( "DATA_ALREADY_INSERTED", "Formulize/ImpressCMS data is stored in your database already. No further data will be stored by this action.<br />Press <em>next</em> to go to the next step." ); // altered by freeform solutions for the formulize 4 installer
...
define( "ERR_NO_XOOPS_FOUND", "No Formulize/ImpressCMS installation could be found in the specified folder." ); // altered by freeform solutions for the formulize 4 installer
...
define( "ERR_CHARSET_NOT_SET", "Default character set is not set for the database." ); // altered by freeform solutions for the formulize 4 installer
...
define("_INSTALL_TRUST_PATH_LABEL", "Formulize/ImpressCMS physical trust path"); // altered by freeform solutions for the formulize 4 installer
...
define("WELCOME_ANONYMOUS","Welcome to Formulize!");
...
define("_INSTALL_LOCAL_SITE",'http://www.freeformsolutions.ca/formulize/'); //Link to local support site // altered by freeform solutions for the formulize 4 installer
define("_LOCAOL_STNAME",'Formulize'); //Link to local support site // altered by freeform solutions for the formulize 4 installer
define("_LOCAL_SLOCGAN",'Custom forms, reporting and workflows'); //Link to local support site // altered by freeform solutions for the formulize 4 installer
define("_LOCAL_FOOTER",''); //footer Link to local support site
