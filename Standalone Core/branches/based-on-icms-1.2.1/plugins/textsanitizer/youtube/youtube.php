...
function render_youtube($ele_name)
{
    ...
    if(isset($xoTheme)){
        ...
        $code = "<img onclick='javascript:icmsCodeYoutube(\"".$ele_name."\", \"".htmlspecialchars(_ENTERYOUTUBEURL, ENT_QUOTES)."\", \"".htmlspecialchars(_ENTERHEIGHT, ENT_QUOTES)."\", \"".htmlspecialchars(_ENTERWIDTH, ENT_QUOTES)."\");' onmouseover='style.cursor=\"pointer\"' src='".ICMS_URL."/plugins/textsanitizer/".basename(dirname(__FILE__))."/youtube.gif' alt='hide' />&nbsp;";
