...
* @version		$Id: install_tpl.php 9684 2009-12-28 12:30:09Z sato $
*/
/**
 *
 */
...
<head>
<title>Formulize installer (<?php echo ($wizard->currentPage+1) . '/' . count($wizard->pages); ?>)</title>
...
<div id="wrapper">
<div id="header">
<div id="logo"><img src="../modules/formulize/images/formulize-logo.png" alt="Formulize" /></div>
<div id="info">Formulize 4 - Standalone installation wizard<?php echo "<br />".INSTALL_STEP; ?>&nbsp;<?php echo ($wizard->currentPage+1) . INSTALL_OUTOF . count($wizard->pages); ?></div>
</div>
...
<div id="footer">
	Installation Wizard <?php echo INSTALL_COPYRIGHT; ?>
</div>
</div>
</body>
</html>