...
* @version		$Id: common.inc.php 8568 2009-04-11 13:15:53Z icmsunderdog $
*/

/**
 * If non-empty, only this user can access this installer
 */
define('XOOPS_VERSION', 'Formulize 4'); // added by freeform solutions for the formulize 4 installer
define( 'INSTALL_USER', '' );
...
/*		elseif ($this->safe_mode) {
			...
			// $this->pages[]= 'langselect'; // removed by freeform solutions - not necessary for Formulize install which is English only at the moment
			$this->pages[]= 'start';
			$this->pages[]= 'modcheck';
      ...
      // $this->pages[]= 'modulesinstall'; // removed by freeform solutions - not necessary for Formulize standalone install
			$this->pages[]= 'end';
		}
		...
		if ($this->no_php5) {
			...
			// $this->pagesNames[] = LANGUAGE_SELECTION; // removed by freeform solutions - not necessary for Formulize install which is English only at the moment
			$this->pagesNames[] = INTRODUCTION; // altered by freeform solutions for Formulize 4 standalone install
			...
			// $this->pagesNames[] = MODULES_INSTALL; // removed by freeform solutions - not necessary for Formulize standalone install
		...
		if ($this->no_php5) {
			...
			// $this->pagesTitles[] = LANGUAGE_SELECTION_TITLE; // removed by freeform solutions - not necessary for Formulize install which is English only at the moment
			...
			// $this->pagesTitles[] = MODULES_INSTALL_TITLE; // removed by freeform solutions - not necessary for Formulize standalone install
