---
layout: default
permalink: documentation/classes/data_handler/findFirstEntryWithAllValues/
redirect_from:
 - developers/classes/data_handler/findFirstEntryWithAllValues/
 - developers/API/classes/data_handler/findFirstEntryWithAllValues/
title: findFirstEntryWithAllValues
---

# findFirstEntryWithAllValues( <span class="sig-type">(array)</span> $elementsAndValues, <span class="sig-type">(string | array)</span> $operator <span class="sig-default">= "="</span>, <span class="sig-type">(string)</span> $fieldsToReturn <span class="sig-default">= "entry_id"</span>  )
