---
layout: default
permalink: documentation/classes/data_handler/findLastEntryWithValue/
redirect_from:
 - developers/classes/data_handler/findLastEntryWithValue/
 - developers/API/classes/data_handler/findLastEntryWithValue/
title: findLastEntryWithValue
---

# findLastEntryWithValue( <span class="sig-type">(int | string | object)</span> $element_identifier, <span class="sig-type">(string)</span> $value, <span class="sig-type">(string)</span>&nbsp;$operator&nbsp;<span class="sig-default">= "="</span>, <span class="sig-type">(array)</span> $scope_uids <span class="sig-default">= array()</span> )
