...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', '/var/www/formulize' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_ROOT_PATH', '/var/www/formulize' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', '/var/www/trustpath' );
	define( 'XOOPS_TRUST_PATH', '/var/www/trustpath' );

	include_once XOOPS_TRUST_PATH . '/0711716eeaf3a6450aa9f03e265b23c0.php' ;
