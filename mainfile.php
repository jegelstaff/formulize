...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', '/var/www/vhosts/dev.freeform.ca/dara.dev.freeform.ca' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_ROOT_PATH', '/var/www/vhosts/dev.freeform.ca/dara.dev.freeform.ca' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', XOOPS_ROOT_PATH.'/abaf94125ae3c24' );
	define( 'XOOPS_TRUST_PATH', XOOPS_ROOT_PATH.'/abaf94125ae3c24' );

	include_once XOOPS_TRUST_PATH . '/23843f7d9e5816359f8e4ae05a3b40e1.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://dara.dev.freeform.ca' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_URL', 'http://dara.dev.freeform.ca' );
	// AS DETERMINED FROM FIRST PRINCIPLES:
	...
	define('XOOPS_URL', ((443 == $_SERVER["SERVER_PORT"] OR $_SERVER['HTTP_X_FORWARDED_PROTO'] == 'https') ? "https://" : "http://") . $_SERVER['SERVER_NAME'] . $PortNum . SITE_BASE_URL );
...
include "core_dara_code.php"; // code that should run every pageload, hacks outside Formulize for Dara
