...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', '/Users/Torboto/git/formulize' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_ROOT_PATH', '/Users/Torboto/git/formulize' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', '/Users/Torboto/git/5b47a3013ec68d7' );
	define( 'XOOPS_TRUST_PATH', '/Users/Torboto/git/5b47a3013ec68d7' );

	include_once XOOPS_TRUST_PATH . '/7f89f6ebad62d5f549ecff6905a8ea82.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://localhost:8888' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_URL', 'http://localhost:8888' );
	// AS DETERMINED FROM FIRST PRINCIPLES:
