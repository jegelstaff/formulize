...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', '/Applications/mampstack-5.4.32-0/apps/formulize/htdocs' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_ROOT_PATH', '/Applications/mampstack-5.4.32-0/apps/formulize/htdocs' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', '/Applications/mampstack-5.4.32-0/apps/1bec728852a5035' );
	define( 'XOOPS_TRUST_PATH', '/Applications/mampstack-5.4.32-0/apps/1bec728852a5035' );

	include_once XOOPS_TRUST_PATH . '/1e2b500d9aa750efe0a08b478c818f82.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://127.0.0.1:8080/formulize' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_URL', 'http://127.0.0.1:8080/formulize' );
	// AS DETERMINED FROM FIRST PRINCIPLES:
	...
	define('XOOPS_URL', "http://localhost:8080/formulize");
