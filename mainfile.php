...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_TRUST_PATH', XOOPS_ROOT_PATH.'/trust' );
	define( 'XOOPS_TRUST_PATH', XOOPS_ROOT_PATH.'/trust' );

	include_once XOOPS_TRUST_PATH . '/b1a61bea7098d7cb42ab5e3354c7693d.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://localhost:8080' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_URL', 'http://localhost:8080' );
	// AS DETERMINED FROM FIRST PRINCIPLES:
  ...
  define( 'XOOPS_DB_CHARSET', 'utf8mb4' );
	...
	define('XOOPS_DB_DSN', 'host='.SDATA_DB_HOST.';dbname='.SDATA_DB_NAME.';charset='.XOOPS_DB_CHARSET);
