...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', '/Applications/MAMP/htdocs/formulize' );
	define( 'XOOPS_ROOT_PATH', '/Applications/MAMP/htdocs/formulize' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', '/Applications/MAMP/698475334900298' );
	define( 'XOOPS_TRUST_PATH', '/Applications/MAMP/698475334900298' );

	include_once XOOPS_TRUST_PATH . '/4d0ccfdc8548a76dd28956ec941bcd07.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://localhost:8888/formulize' );
	define( 'XOOPS_URL', 'http://localhost:8888/formulize' );
