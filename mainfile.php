...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', 'C:/VertrigoServ/www/Formulize' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_ROOT_PATH', 'C:/VertrigoServ/www/Formulize' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', 'C:/VertrigoServ/f196da737cb6d48' );
	define( 'XOOPS_TRUST_PATH', 'C:/VertrigoServ/f196da737cb6d48' );

	include_once XOOPS_TRUST_PATH . '/c7dbee91d5e39d74936eb3e8e313b0e7.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://127.0.0.1/Formulize' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_URL', 'http://127.0.0.1/Formulize' );
	// AS DETERMINED FROM FIRST PRINCIPLES:
