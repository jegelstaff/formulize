...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', 'C:/xampp5.6/htdocs/formulize' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_ROOT_PATH', 'C:/xampp5.6/htdocs/formulize' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', XOOPS_ROOT_PATH.'/trustpath' );
	define( 'XOOPS_TRUST_PATH', XOOPS_ROOT_PATH.'/trustpath' );

	include_once XOOPS_TRUST_PATH . '/7f3a39fa3c96863480b13ef5b4f53acd.php' ;
