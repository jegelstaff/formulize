...
foreach($courses as $course) {
	$html .= "<LI>{$course['code']} - {$course['title']}, Section {$course['section']}{$course['reserved']}, {$course['times']}, {$course['room']}";
...
$html .= "<P style=\"text-align:justify;\">A statement about the Union, along with other information about the Union can be found on the Union's website (<A HREF='https://www.cupe3902.org/unit-3/'>https://www.cupe3902.org/unit-3/</A>). All of this information is that of the Union, represents the views of the Union and has not been approved or endorsed by the University.</P>";
...
if($rank == 'Sessional Lecturer I') {
	$html .= "<P style=\"text-align:justify;\">You could be eligible for consideration for advancement to the next rank if with this appointment you will have taught in four (4) of the last six (6) years and at least eight (6) half courses.</P>";
}
if($rank == 'Sessional Lecturer II') {
	$html .= "<P style=\"text-align:justify;\">You could be eligible for consideration for advancement to the next rank if with this appointment you are beginning your fourth year at the rank of Sessional Lecturer II, and have taught an average of three (3) half courses per year in the preceding three (3) years.</P>";
}
