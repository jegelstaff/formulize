...
if(strstr($rank, 'Writing')) {
    ...
    $html .= "<P>You will be paid $totalSalary, inclusive of vacation pay. Your salary will be paid by direct deposit.</P>";
}
...
if(strstr($rank, 'Writing')) {
    ...
    $html .= "<P>You will be responsible for teaching the following course(s):<UL>";
...
$html .= "<P><B>Mandatory Training</B><BR>You are required to take the following mandatory training. You must complete this training within 60 days of hire.<OL>  
...
<P>Please note that you only need to take the above training programs once with the University (although you may need to retake one or both training programs if they are updated or amended). If you have already taken one or both of these training programs please confirm with your supervisor.</P>";
...
<P><B>Benfits</B><BR>Information regarding the Health Care Spending Account and the enrollment form may be found at <A HREF='http://benefits.hrandequity.utoronto.ca/cupe-local-3902-unit-3-health-care-spending-account/'>benefits.hrandequity.utoronto.ca/cupe-local-3902-unit-3-health-care-spending-account/</A></P>";
...
<P>This offer is conditional on your being legally entitled to work in Canada, in this position.</P> 
